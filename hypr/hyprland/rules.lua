...
hl.window_rule({ match = { class = "org.gnome.Calculator" }, tag = "+float_50_60" })
...
-- OpenGL Dev
hl.window_rule({ match = { class = "opengl_demo" }, rounding = 0, float = true, center = true })
...
hl.window_rule({ match = { class = "discord|equibop|vesktop|whatsapp|teams-for-linux" }, workspace = "special:communication" })
